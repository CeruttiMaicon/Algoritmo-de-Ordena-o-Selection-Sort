...
public class MainCSV {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // rota
            FileWriter writer = new FileWriter("/home/dev3/Documentos/arraySelectionSort.csv");

            // Faz o cabeçalho do arquivo CSV

            writer.append("SeletionSort-Cresc,");
            writer.append("SeletionSort-Decresc,");
            writer.append("SeletionSort-Aleatorio,");
            ...
            for (int n = 1; n <= 100; n++) {
                ...
                writer.append(selectionSort1.recebeVetor(crescenteVar) + ",");
                writer.append(selectionSort2.recebeVetor(decrescenteVar) + ",");
                writer.append(selectionSort3.recebeVetor(aleatorioVar) + ",");
                writer.append('\n');
